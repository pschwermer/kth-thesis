package com.benchmarks.patrik.benchmarks.java;
...
public class ReverseComplement {
    ...
    public void runBenchmark(String[] args) throws Exception {
        //Sends file instead of reading from System.in!
        InputStream is = this.getClass().getClassLoader().getResourceAsStream("assets/"+args[0]);
        solve(is);
    }
}